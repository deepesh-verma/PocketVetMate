...
import {
  ...
  Divider,
  Avatar, Popover,
  Layout, BottomNavigation, BottomNavigationTab, useTheme
...
const HomeScreen = () => {
  ...
  const DisclaimerHeader = (props: ViewProps): React.ReactElement => (
    <View {...props}>
      <Text category="h5" status='danger'>Disclaimer</Text>
    </View>
  );

  const ContributorsHeader = (props: ViewProps): React.ReactElement => (
    <View {...props}>
      <Text category="h5" status='info'>Contributors</Text>
    </View>
  );
  ...
  const MoreInfoSection = () => (
          ...
          <ScrollView>
            ...
            <Card style={styles.card} header={ContributorsHeader} appearance="filled">
              ...
              <Text category='h6'>Nanaji Deshmukh Veterinary Science University, Jabalpur</Text>
  ...
  return (
    ...
    <ImageBackground source={require('../assets/images/bg.jpeg')} resizeMode='cover' style={{height: height}}>
      ...
      <View style={[styles.banner, {backgroundColor: theme['color-primary-default']}]}>
        ...
        {selectedIndex === 0 && searchPressed && finalValue ? <ParameterDetails></ParameterDetails> : <></>}
